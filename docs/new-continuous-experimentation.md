...
```bash
# Default execution
./run_experiment_better.sh

# Custom URL
SMS_URL=http://custom.domain/sms ./run_experiment_better.sh
```

**Configuration:** 15min duration, 9 stable users (20% activity), 1 canary user (60% activity)
...
![Experiment Dashboard](./screenshots/a4-experiment-dashboard.png)
